...
import {
  DombHtmlInputText,
  DombHtmlInputCheckbox,
  DombHtmlInputSubmit,
  ElementConfigWithModel,
} from "./dombHtmlInputElements";
...
function dombElementOf<K extends keyof HTMLElementTagNameMap>(
  tagName: K
): (...modifiers: Modifiers<ElementConfig<HTMLElementTagNameMap[K]>>) => DombDynamicHtmlElement<K> {
